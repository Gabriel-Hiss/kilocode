...
export async function startIndexing(
	...
	try {
		...
		try {
			...
			logger.warn("[Managed Indexing] Failed to fetch updated manifest after indexing:", error)
		}
		...
		try {
			...
			gitWatcher = createGitWatcher(config, context, onStateChange)
			...
			console.error("[Managed Indexing] ✗ Failed to start git watcher:", error)
			logger.error("[Managed Indexing] Failed to start git watcher:", error)
